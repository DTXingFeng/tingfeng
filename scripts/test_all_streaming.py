...
async def test_decision_engine():
    ...
    try:
        ...
        result = await should_i_reply(
            group_id=test_group_id, user_name=test_user, current_msg=test_message, is_at_me=True, user_id=999
        )
...
async def test_chat_reply():
    ...
    try:
        ...
        result = await get_chat_reply(
            group_id=test_group_id, user_name=test_user, current_msg=test_message, user_id=999
        )
