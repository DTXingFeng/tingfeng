...
class MemorySearchTool(BaseTool):
    ...
    async def execute(self, query: str, group_id: int, limit: int = 3) -> Dict[str, Any]:
        ...
        try:
            ...
            # 查询向量数据库
            memories = vector_db.query_memory(group_id, query_vector, n_results=limit)
...
class AddMemoryTool(BaseTool):
    ...
    async def execute(self, user_name: str, group_id: int, content: str) -> Dict[str, Any]:
        ...
        Returns:
            dict: 添加结果
        """
        db_manager.add_user_specific_memory(group_id, user_name, content)
